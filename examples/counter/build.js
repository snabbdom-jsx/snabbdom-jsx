...
var view = function view(_ref) {
  ...
  return (0, _snabbdomJsx.html)(
    ...
    (0, _snabbdomJsx.html)(
      'button',
      {
        'on-click': [handler, Action.Increment()] },
      '+'
    ),
    (0, _snabbdomJsx.html)(
      'button',
      {
        'on-click': [handler, Action.Decrement()] },
      '-'
    ),
    (0, _snabbdomJsx.html)(
      'div',
...
var view = function view(_ref) {
  ...
  return (0, _snabbdomJsx.html)(
    ...
    (0, _snabbdomJsx.html)(
      'button',
      {
        'on-click': [handler, Action.Add()] },
      'Add'
    ),
    (0, _snabbdomJsx.html)(
      'button',
      {
        'on-click': [handler, Action.Reset()] },
      'Reset'
    ),
    ...
    (0, _snabbdomJsx.html)(
      ...
      model.counters.map(function (item) {
        return (0, _snabbdomJsx.html)(CounterItem, { item: item, handler: handler });
      })
    )
  );
};
...
},{"../../../snabbdom-jsx":17,"./counter":1,"union-type":16}],3:[function(require,module,exports){
'use strict';
