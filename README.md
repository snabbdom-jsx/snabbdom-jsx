...
This has allowed us to implement snabbdom for the build output, but also test our components with React tools such as [enzyme](https://github.com/airbnb/enzyme).
